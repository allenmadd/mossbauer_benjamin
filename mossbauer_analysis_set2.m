...
energypoint5 = energy(86:1:140);
peakpoint5= mossbauer_data_no_background(86:140,1);
weightpoint5 = 1./(absorption_error(86:140).^2);
%do this for all of the peaks this is just peak 1
cpoint5 = [1.575*10^-15,2.623*10^-7,(10^-18)]; %changed name to "constant 1" aka "c1"
...
%do this for all of the peaks this is just peak 1
c1 = [1559*10^(-18),1.559*10^(-7),(10^-18)]; %changed name to "constant 1" aka "c1"
...
%line width squared for peak 1 with  error  4.6919e-17    6.4072e-18 
%transition energy: 1.5656e-07     3.873e-22 
...
%do this for all of the peaks this is just peak 1
c1point5 = [921.5*10^-18,5.125*10^-8,(10^-18)]; 
...
%line width squared:   2.9145e-17    6.4289e-18
%transition energy: 5.2509e-08    4.9735e-24
...
%line width:  3.6456e-17    8.2088e-18   
%transition energy:  -2.5358e-08    1.4541e-22


%PEAK 2point5 (secretly peak 5)
%this good make it look like this
energy2point5 = energy(292:1:336);
peak2point5= mossbauer_data_no_background(292:336,1);
weight2point5=1./(absorption_error(292:336).^2);

%do this for all of the peaks this is just peak 1
c2point5 = [1346*10^-18,-1.294*10^-7,(10^-18)]; 
...
%line width squared:   3.8521e-17    5.6184e-18 
%transition energy: -1.2987e-07    2.8055e-23 
...
%line width: 5.1134e-17    4.2101e-18 
%transition energy: -2.337e-07    5.4344e-22
...
%line width: 4.935e-17    5.7921e-18
%transition energy: -1.5293e-07    3.9575e-22
...
%do this for all of the peaks this is just peak 1
c4point5 = [912.5*10^-18,-4.954*10^-8,(10^-18)]; 
...
%line width: 4.0206e-17    6.5187e-18
%transition energy: -5.0539e-08    2.9272e-23 
...
c5= [ 1066*10^-18,2.463*10^-8,(10^-18)];
...
%line width: 3.3352e-17     6.841e-18 
%transtion energy: 2.4857e-08    2.9889e-23 

%PEAK 5point5 (secretly peak 11)
%this good make it look like this
energy5point5 = energy(805:1:841);
peak5point5= mossbauer_data_no_background(805:841,1);
weight5point5=1./(absorption_error(805:841).^2);

%do this for all of the peaks this is just peak 1
c5point5 = [1494*10^-18,1.273*10^-7,(10^-18)]; 
...
%line width:  4.0816e-17    4.5062e-18
%transition energy:  1.2764e-07    2.1725e-22
